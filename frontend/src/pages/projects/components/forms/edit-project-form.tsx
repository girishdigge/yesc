...
import { ProjectFormValues, projectSchema } from '@/lib/form-schema';
import { getProjectById, updateProject } from '@/lib/projectAPI';
import { Button } from '@/components/ui/button';

type FieldName = keyof ProjectFormValues;
const title = 'Edit Project';
const description = 'To Edit project, Update the information about project.';
const steps = [
  {
    id: 'Step 1',
...
const EditProject = (props) => {
  ...
  // const [initialData, setInitialData] = useState<ProjectFormValues | null>(
  //   null
  // );
  ...
  const processForm = async (data: ProjectFormValues) => {
    if (id) {
      try {
  ...
  //       fields as Array<keyof ProjectFormValues>,
  //       { shouldFocus: true }
  //     );
  //     if (!output) return;
  ...
  //       <Heading
  //         title="Edit Project"
  //         description="Update the information about your project."
  //       />
  //       <Separator />
              ...
              <>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Terrace Floor</FormLabel>
                        <FormControl>
                          <Select
                            disabled={loading}
                            onValueChange={(value) => {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Staircase Cap</FormLabel>
                        <FormControl>
                          <Select
                            disabled={loading}
                            onValueChange={(value) => {
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Remarks (Additional Info)</FormLabel>
                        <FormControl>
                          <Input
                            disabled={loading}
